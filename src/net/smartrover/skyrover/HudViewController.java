...
import net.smartrover.skyrover.HexMiniApplication.AppStage;
import net.smartrover.skyrover.ble.BleConnectinManager;
import net.smartrover.skyrover.gestures.EnhancedGestureDetector;
import net.smartrover.skyrover.modal.ApplicationSettings;
import net.smartrover.skyrover.modal.Channel;
import net.smartrover.skyrover.modal.OSDCommon;
import net.smartrover.skyrover.modal.Transmitter;
import net.smartrover.skyrover.sensors.DeviceOrientationChangeDelegate;
import net.smartrover.skyrover.sensors.DeviceOrientationManager;
import net.smartrover.skyrover.sensors.DeviceSensorManagerWrapper;
import net.smartrover.skyrover.ui.Button;
import net.smartrover.skyrover.ui.ToggleButton;
import net.smartrover.skyrover.ui.Image;
import net.smartrover.skyrover.ui.Indicator;
import net.smartrover.skyrover.ui.Sprite;
import net.smartrover.skyrover.ui.Text;
import net.smartrover.skyrover.ui.UIRenderer;
import net.smartrover.skyrover.ui.Image.SizeParams;
import net.smartrover.skyrover.ui.Sprite.Align;
import net.smartrover.skyrover.ui.joystick.AcceleratorJoystick;
import net.smartrover.skyrover.ui.joystick.AnalogueJoystick;
import net.smartrover.skyrover.ui.joystick.JoystickBase;
import net.smartrover.skyrover.ui.joystick.JoystickFactory;
import net.smartrover.skyrover.ui.joystick.JoystickFactory.JoystickType;
import net.smartrover.skyrover.ui.joystick.JoystickListener;
import net.smartrover.skyrover.util.FontUtils;
...
public class HudViewController extends ViewController
    ...
    public HudViewController(Activity context, HudViewControllerDelegate delegate) {
        ...
        Image middleBg = new Image(res, R.drawable.middle_bg_tile, Align.CENTER);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (result != true) {
            ...
            for (int i=0; i<joysticks.length; ++i) {
                ...
                if (joy != null) {
                    if (joy.processTouch(v, event)) { result = true; }
                }
            }
        }
