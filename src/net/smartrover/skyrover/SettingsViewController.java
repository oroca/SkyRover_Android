...
//import net.smartrover.skyrover.drone.DroneConfig;
//import net.smartrover.skyrover.drone.DroneConfig.EDroneVersion;
import net.smartrover.skyrover.adapter.SettingsViewAdapter;
import net.smartrover.skyrover.ble.BleConnectinManager;
import net.smartrover.skyrover.ble.BleConnectinManagerDelegate;
...
//import  net.smartrover.skyrover.ui.adapters.SettingsViewAdapter;
//import  net.smartrover.skyrover.ui.controls.ViewPagerIndicator;
//import  net.smartrover.skyrover.ui.filters.NetworkNameFilter;
//import  net.smartrover.skyrover.ui.listeners.OnSeekChangedListener;
//import  net.smartrover.skyrover.utils.FontUtils;
import net.smartrover.skyrover.ui.control.ViewPagerIndicator;
...
public class SettingsViewController extends ViewController
        implements OnPageChangeListener, OnClickListener, BleConnectinManagerDelegate {
   ...
   //private OnSeekBarChangeListener rudderDeadBandSeekBarListener;
    ...
    public SettingsViewController(Context context, LayoutInflater inflater, ViewGroup container, SettingsViewControllerDelegate delegate) {
       ...
       // rudderDeadBandValueTextView = (TextView)settingsViews.get(modePageIdx).findViewById(R.id.rudderDeadBandValueTextView);
        ...
        if ("zh".equals(language)) {
            ...
            aboutWebView.loadUrl("file:///android_asset/About-ko.html");
        } else {
    ...
    class BleDeviceListAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (mLeDevices.get(position).getName() == null || "".equals(mLeDevices.get(position).getName())) {
                bleDeviceNameTextView.setText(String.format("%s [%s]", R.string.unknown, mLeDevices.get(position).getAddress()));
            } else {
                bleDeviceNameTextView.setText(String.format("%s [%s]", mLeDevices.get(position).getName(),  mLeDevices.get(position).getAddress()));
            }
